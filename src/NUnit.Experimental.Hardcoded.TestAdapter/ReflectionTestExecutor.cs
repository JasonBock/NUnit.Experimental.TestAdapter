...
//	{
//		frameworkHandle.SendMessage(TestMessageLevel.Informational, "RunTests from tests started...");
...
//				frameworkHandle.SendMessage(TestMessageLevel.Informational, $"RunTests, looking for {name[0]}::{name[1]}...");
...
//		frameworkHandle.SendMessage(TestMessageLevel.Informational, "RunTests from tests finished.");
//	}

//	public void RunTests(IEnumerable<string> sources, IRunContext runContext, IFrameworkHandle frameworkHandle)
//	{
//		frameworkHandle.SendMessage(TestMessageLevel.Informational, "RunTests from sources started...");

//		foreach (var source in sources)
//		{
//			frameworkHandle.SendMessage(TestMessageLevel.Informational, $"{nameof(source)} is {source}");
...
//		frameworkHandle.SendMessage(TestMessageLevel.Informational, "RunTests from sources finished.");
//	}
//}